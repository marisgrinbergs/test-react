...
const getStatsMetrics = job => {
  ...
  return Object.entries(metrics).reduce((agg, [key, value]) => _objectSpread(_objectSpread({}, agg), {}, {
    [`webpack.${key}`]: value
  }), {});
};
/**
...
const getSizeMetrics = job => {
  ...
  return Object.keys(_metrics.metrics.sizes).reduce((agg, key) => _objectSpread(_objectSpread({}, agg), {}, {
