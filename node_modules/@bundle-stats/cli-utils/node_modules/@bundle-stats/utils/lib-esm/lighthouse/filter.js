...
const filter = source => {
  ...
  const categories = Object.entries(source.categories).reduce((agg, [categoryId, categoryData]) => _objectSpread(_objectSpread({}, agg), {}, {
    [categoryId]: (0, _pick2.default)(categoryData, ['score'])
  }), {}); // filter audits

  const audits = Object.entries(source.audits).reduce((agg, [auditId, auditData]) => _objectSpread(_objectSpread({}, agg), {}, {
