...
var _createJob = require("./create-job");
...
const createJobs = sources => {
  const jobs = (0, _reverse2.default)([...sources]).reduce((agg, source, idx) => {
    const job = (0, _createJob.createJob)(source, (0, _last2.default)(agg));
